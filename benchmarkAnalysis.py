...
pathList = ["1.0to2.0DegreeSorted/Benchmarking0.025min_30max_150.pkl", "1.0to1.0DegreeSorted/Benchmarking0.025min_30max_150.pkl", "2.0to1.0DegreeSorted/Benchmarking0.025min_30max_150.pkl","Max50EarsMaxLength20RandomMREar/Benchmarking_NoEars_22_MaxEarLength_16.pkl"]
...
for p in pathList:
    ...
    if "NoEars" in p:
        ...
        minNoNodes = int(p.split("max_")[0].split("_")[1])
        maxNoNodes = int(p.split("max_")[1].split(".")[0])
