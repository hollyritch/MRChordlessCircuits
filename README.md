...
- -c or --cutOff <cutOffValue>         : Minimum size of a module (a reaction network) - in terms of number of reactions - that is generated by the partitioning algorithm, default=2. **Use c=1 or c=0 if you want to account for explicit autocatalytic reactions!!**
